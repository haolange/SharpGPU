...
textureInfo.UsageFlag = ETextureUsage::RenderTarget | ETextureUsage::UnorderedAccess;
...
rhi::RHIBuffer* rhiIndexBufferGPU = renderContext.CreateBuffer(indexBufferInfo);
...
vertexBufferInfo.StorageMode = EStorageMode.GPULocal;
rhi::RHIBuffer* rhiVertexBufferGPU = renderContext.CreateBuffer(vertexBufferInfo);
```
