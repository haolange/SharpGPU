...
An explicit hardware abstraction over modern graphics APIs. Unsupported work fails closed.

DirectX 12 × Vulkan × Metal

[简体中文](README.md) · [Design](#design) · [Issues](https://github.com/haolange/SharpGPU/issues)

## A hardware abstraction, not a renderer
