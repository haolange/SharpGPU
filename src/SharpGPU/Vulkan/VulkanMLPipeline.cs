...
#pragma warning disable CS8618
    internal unsafe class VulkanMLPipeline : RHIMLPipeline
    {
        ...
        public VulkanMLPipeline(VulkanDevice device, in RHIMLPipelineDescriptor descriptor)
        {
            ...
            // ML pipelines are not natively supported in Vulkan.
            // This is a stub implementation. In practice, ML inference would be
            // implemented via compute shaders or an external ML runtime.
        }
