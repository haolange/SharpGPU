...
namespace SharpGPU
{
    ...
    public enum ERHIExternalFence64Direction : byte
    {
        Export = 0,
        Import = 1,
    }

    public enum ERHIExternalHandleKind : byte
    {
        Win32NtShared = 0,
    }
    ...
    public readonly struct RHIExternalFence64CreateDescriptor
    {
        public ulong InitialValue { get; }

        public RHIExternalFence64CreateDescriptor(ulong initialValue = 0)
        {
            InitialValue = initialValue;
        }
    }

    public readonly struct RHIExternalFence64ImportDescriptor
    {
        ...
        public RHIExternalFence64ImportDescriptor(
            IntPtr handle,
            ulong value = 0,
    ...
    public readonly struct RHIExternalFence64Export
    {
        public IntPtr Handle { get; }
        public ulong Value { get; }
        public ERHIExternalHandleKind HandleKind { get; }
        ...
        public RHIExternalFence64Export(
            IntPtr handle,
            ulong value,
            ERHIExternalHandleKind handleKind,
    ...
    internal static class RHIWin32NtHandle
    {
        public const uint DuplicateSameAccess = 2;

        public static IntPtr Duplicate(IntPtr handle)
        {
            if (handle == IntPtr.Zero)
            {
                throw new ArgumentException("NT handle is null.", nameof(handle));
            }
            ...
            {
                throw new InvalidOperationException(
                    $"DuplicateHandle failed (Win32 0x{Marshal.GetLastPInvokeError():X8}).");
            }
    ...
    public abstract class RHIExternalFence64 : Disposal
    {
        public ERHIExternalFence64Direction Direction
        {
            get
            {
                ThrowIfDisposed();
        ...
        private readonly ERHIExternalFence64Direction m_Direction;

        protected RHIExternalFence64(
            object ownerDevice,
            ERHIExternalFence64Direction direction)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(direction), direction, "Unknown ExternalFence64 direction.");
            }
        ...
        protected void ThrowIfExternalDisposed()
        {
            if (IsDisposed)
            {
