...
- [DESIGN.md:1-8](file://DESIGN.md#L1-L8)
...
- [DESIGN.md:11-13](file://DESIGN.md#L11-L13)
...
- 证据与不可用平台：使用当前构建/测试/运行证据；无法匹配平台的执行标记 TODO(UNZIPED) 或 BLOCKED_PLATFORM。
...
**章节来源**
- [AGENTS.md:13-33](file://AGENTS.md#L13-L33)
...
**章节来源**
- [DESIGN.md:5-13](file://DESIGN.md#L5-L13)
...
### 文档更新要求
- 权威文档：README、DESIGN、VERIFICATION 为权威来源；契约变化需同步更新。
