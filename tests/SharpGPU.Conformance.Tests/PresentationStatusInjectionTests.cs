...
namespace SharpGPU.Conformance.Tests
{
    ...
    public sealed class PresentationStatusInjectionTests
    {
        ...
        private sealed class ScriptedDevice : RHIDevice
        {
            ...
            public override RHIComputeIndirectCommandBuffer
                CreateComputeIndirectCommandBuffer(
                    in RHIComputeIndirectCommandBufferDescription
                        descriptor) =>
                Unsupported<RHIComputeIndirectCommandBuffer>();

            public override RHIRayTracingIndirectCommandBuffer
                CreateRayTracingIndirectCommandBuffer(
                    in RHIRayTracingIndirectCommandBufferDescription
                        descriptor) =>
                Unsupported<RHIRayTracingIndirectCommandBuffer>();

            public override RHIRasterIndirectCommandBuffer
                CreateRasterIndirectCommandBuffer(
                    in RHIRasterIndirectCommandBufferDescription
                        descriptor) =>
