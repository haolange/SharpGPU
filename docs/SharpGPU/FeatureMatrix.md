...
|---|---|---|
| Windows x64 | `docs/Artifacts/SharpGPU/feature-report-win-x64.json` | Regenerated after G2 exact-contract wave; schema revision 4; pipeline ABI 8. Not a substitute for matching-host qualified gates |
